...
should_skip() {
    case "$1" in
        *.lock|Cargo.lock|weave.lock|.github/workflows/*|.agents/*|.claude/*|.csa/*|.gitnexus/*|crates/cps-agent/src/agent_loop.rs|crates/cps-policy/src/lib.rs|crates/cps-policy/src/checker.rs|crates/cps-doc-runner/src/lib.rs)
            return 0
            ;;
        *)
            return 1
